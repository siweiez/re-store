        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ItemOrdered_PicUrl = table.Column<string>(type: "TEXT", nullable: true),
                    Price = table.Column<long>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "3ae5d87d-8e3f-4767-acb7-b11a03aedb00", "Member", "MEMBER" });

            migrationBuilder.InsertData(
                table: "AspNetRoles",
                columns: new[] { "Id", "ConcurrencyStamp", "Name", "NormalizedName" },
                values: new object[] { 2, "b63d3847-c03e-498d-ac6e-3ec3e5077974", "Admin", "ADMIN" });
